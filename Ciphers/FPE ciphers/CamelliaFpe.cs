...
public class CamelliaFpe
{
    ...
    public CamelliaFpe(Span<byte> key, char[] alphabet, string tweakString = "0123456")
    {
        ...
        IBlockCipher cipherEncrypt = new CamelliaEngine(),
            cipherDecrypt = new CamelliaEngine();
