...
public class SerpentFpe
{
    ...
    public SerpentFpe(Span<byte> key, char[] alphabet, string tweakString = "0123456")
    {
        ...
        IBlockCipher cipherEncrypt = new SerpentEngine(),
            cipherDecrypt = new SerpentEngine();
