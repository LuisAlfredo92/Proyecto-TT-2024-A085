...
public class SCryptTests
{
    ...
    public void TestSCrypt(string p, string s, int n, int r, int parallel, int dkLen, string expected)
    {
        var sCrypt = new SCrypt(Encoding.ASCII.GetBytes(s), n, r, parallel, dkLen);
