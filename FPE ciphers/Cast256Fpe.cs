...
public class Cast256Fpe
{
    ...
    public Cast256Fpe(Span<byte> key, char[] alphabet, string tweakString = "0123456")
    {
        ...
        IBlockCipher cipherEncrypt = new Cast6Engine(),
            cipherDecrypt = new Cast6Engine();
