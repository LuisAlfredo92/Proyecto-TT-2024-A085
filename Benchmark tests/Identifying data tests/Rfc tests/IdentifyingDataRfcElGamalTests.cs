...
public class IdentifyingDataRfcElGamalTests
{
    ...
    [GlobalSetup(Target = nameof(EncryptRfcElGamal))]
    ...
    [Benchmark]
    public byte[] EncryptRfcElGamal() => _elGamal.Encrypt(_rfc);

    [GlobalSetup(Target = nameof(DecryptRfcElGamal))]
    public void SetupDecryption()
    {
        ...
        _rfc = _elGamal.Encrypt(generatedRfc);
    }

    [Benchmark]
    public byte[] DecryptRfcElGamal() => _elGamal.Decrypt(_rfc);
}