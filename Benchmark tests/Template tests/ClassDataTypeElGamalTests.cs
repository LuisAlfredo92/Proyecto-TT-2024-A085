...
public class ClassDataTypeElGamalTests
{
    ...
    [GlobalSetup(Target = nameof(EncryptTypeElGamal))]
    ...
    [Benchmark]
    public byte[] EncryptTypeElGamal() => _elGamal.Encrypt(_yourData);

    [GlobalSetup(Target = nameof(DecryptTypeElGamal))]
    ...
    [Benchmark]
    public byte[] DecryptTypeElGamal() => _elGamal.Decrypt(_yourData);
}