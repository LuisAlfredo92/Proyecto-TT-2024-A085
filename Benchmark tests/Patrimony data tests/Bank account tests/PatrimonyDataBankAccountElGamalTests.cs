...
public class PatrimonyDataBankAccountElGamalTests
{
    ...
    [GlobalSetup(Target = nameof(EncryptBankAccountElGamal))]
    ...
    [Benchmark]
    public byte[] EncryptBankAccountElGamal() => _elGamal.Encrypt(_bankAccount);

    [GlobalSetup(Target = nameof(DecryptBankAccountElGamal))]
    public void SetupDecryption()
    {
        ...
        _bankAccount = _elGamal.Encrypt(generatedBankAccount);
    }

    [Benchmark]
    public byte[] DecryptBankAccountElGamal() => _elGamal.Decrypt(_bankAccount);
}