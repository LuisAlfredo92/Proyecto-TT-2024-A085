...
public class PatrimonyDataTransactionStateElGamalTests
{
    ...
    [GlobalSetup(Target = nameof(EncryptTransactionStateElGamal))]
    ...
    [Benchmark]
    public byte[] EncryptTransactionStateElGamal() => _elGamal.Encrypt(_transactionState);

    [GlobalSetup(Target = nameof(DecryptTransactionStateElGamal))]
    public void SetupDecryption()
    {
        ...
        _transactionState = _elGamal.Encrypt(generatedTransactionState);
    }

    [Benchmark]
    public byte[] DecryptTransactionStateElGamal() => _elGamal.Decrypt(_transactionState);
}