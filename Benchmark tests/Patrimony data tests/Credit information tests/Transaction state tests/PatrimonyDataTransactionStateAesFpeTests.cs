...
public class PatrimonyDataTransactionStateAesFpeTests
{
    ...
    [GlobalSetup(Target = nameof(EncryptTransactionStateAesFpe))]
    ...
    [Benchmark]
    public char[] EncryptTransactionStateAesFpe() => _aesFpe.Encrypt(_transactionState);

    [GlobalSetup(Target = nameof(DecryptTransactionStateAesFpe))]
    public void SetupDecryption()
    {
        ...
        _transactionState = _aesFpe.Encrypt(generatedTransactionState);
    }

    [Benchmark]
    public char[] DecryptTransactionStateAesFpe() => _aesFpe.Decrypt(_transactionState);
}