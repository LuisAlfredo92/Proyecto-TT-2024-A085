...
public class PatrimonyDataCreditCardNumberElGamalTests
{
    ...
    [GlobalSetup(Target = nameof(EncryptCreditCardNumberElGamal))]
    ...
    [Benchmark]
    public byte[] EncryptCreditCardNumberElGamal() => _elGamal.Encrypt(_creditCardNumber);

    [GlobalSetup(Target = nameof(DecryptCreditCardNumberElGamal))]
    public void SetupDecryption()
    {
        ...
        _creditCardNumber = _elGamal.Encrypt(generatedCreditCardNumber);
    }

    [Benchmark]
    public byte[] DecryptCreditCardNumberElGamal() => _elGamal.Decrypt(_creditCardNumber);
}