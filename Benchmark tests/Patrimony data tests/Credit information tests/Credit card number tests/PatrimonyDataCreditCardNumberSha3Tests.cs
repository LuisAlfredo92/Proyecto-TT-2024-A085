...
public class PatrimonyDataCreditCardNumberSha3Tests
{
    private byte[] _creditCardNumber = null!;

    [GlobalSetup(Target = nameof(EncryptCreditCardNumberSha3))]
    ...
    [Benchmark]
    public Span<byte> EncryptCreditCardNumberSha3() => Sha3.Hash(_creditCardNumber);
}