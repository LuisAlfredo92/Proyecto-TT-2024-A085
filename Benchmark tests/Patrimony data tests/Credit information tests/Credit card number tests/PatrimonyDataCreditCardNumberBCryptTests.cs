...
public class PatrimonyDataCreditCardNumberBCryptTests
{
    private readonly BCrypt _argon2Id = new();
    private byte[] _creditCardNumber = null!;

    [GlobalSetup(Target = nameof(EncryptCreditCardNumberBCrypt))]
    ...
    [Benchmark]
    public Span<byte> EncryptCreditCardNumberBCrypt() => _argon2Id.Hash(_creditCardNumber);
}