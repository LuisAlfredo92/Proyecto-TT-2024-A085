...
public class TransitAndMigratoryDataAutomobileLicensePlateBlake3Tests
{
    private byte[] _automobileLicensePlate = null!;

    [GlobalSetup(Target = nameof(EncryptAutomobileLicensePlateBlake3))]
    ...
    [Benchmark]
    public Span<byte> EncryptAutomobileLicensePlateBlake3() => Blake3.Hash(_automobileLicensePlate);
}